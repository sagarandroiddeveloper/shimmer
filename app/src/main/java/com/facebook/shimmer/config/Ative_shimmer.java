...
public class Ative_shimmer {

    public static void fb_shimmer_Ative(final Activity activity, final LinearLayout frameLayout) {
        AdLoader adLoader = new AdLoader.Builder(activity, "/6499/example/native")
                .forNativeAd(new NativeAd.OnNativeAdLoadedListener() {
                    @Override
                    public void onNativeAdLoaded(NativeAd nativeAd) {
                        Log.d("onNativeAdLoaded12", "onNativeAdLoaded ");
                ...
                .withAdListener(new AdListener() {
                    ...
                    public void onAdFailedToLoad(LoadAdError adError) {
                        Log.d("onNativeAdLoaded12", "onAdFailedToLoad ");
                    }
                })
